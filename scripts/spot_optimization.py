"""Estimate spot/preemptible savings from the command line."""
...
def analyze_spot_opportunities(days: int = 30, discount_pct: float = 0.65) -> dict:
    verify_pro_license("CLI Spot Optimization")
    print(f"Analyzing {days} days of spot / preemptible opportunities...")
    ...
    if compute.empty:
        print("No compute workloads found in telemetry.")
